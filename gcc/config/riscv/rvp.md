...
(define_insn "kaddh"
  [(match_operand:SI 0 "register_operand" "=r")
   (unspec:HI [(match_operand:HI 1 "register_operand" "r")
               (match_operand:HI 2 "register_operand" "r")] UNSPEC_KADDH)]
  "TARGET_ZPN"
  "kaddh\t%0, %1, %2"
  [(set_attr "type" "dsp")
   (set_attr "mode" "SI")])
...
(define_insn "ksubh"
  [(match_operand:SI 0 "register_operand" "=r")
   (unspec:HI [(match_operand:HI 1 "register_operand" "r")
               (match_operand:HI 2 "register_operand" "r")] UNSPEC_KSUBH)]
  "TARGET_ZPN"
  "ksubh\t%0, %1, %2"
  [(set_attr "type" "dsp")
   (set_attr "mode" "SI")])
...
(define_insn "ukaddh"
  [(match_operand:SI 0 "register_operand"             "=r")
   (unspec:HI [(match_operand:HI 1 "register_operand" "r")
               (match_operand:HI 2 "register_operand" "r")] UNSPEC_UKADDH)]
  "TARGET_ZPN"
  "ukaddh\t%0, %1, %2"
  [(set_attr "type" "dsp")
   (set_attr "mode" "SI")])
...
(define_insn "uksubh"
  [(match_operand:SI 0 "register_operand"             "=r")
   (unspec:HI [(match_operand:HI 1 "register_operand" "r")
               (match_operand:HI 2 "register_operand" "r")] UNSPEC_UKSUBH)]
  "TARGET_ZPN"
  "uksubh\t%0, %1, %2"
  [(set_attr "type" "dsp")
   (set_attr "mode" "SI")])
...
(define_insn "<rvp_optab><mode>2"
  ...
  "TARGET_ZPN || TARGET_ZBB || TARGET_ZBPBO"
  "<rvp_insn><bits>\t%0, %1"
  [(set_attr "type" "simd")
   (set_attr "mode" "<MODE>")])
...
;; MADDR32, MSUBR32: rd = __rv_maddr32(rd, rs1, rs2)
(define_insn "maddr32"
  [(set (match_operand:SI 0 "register_operand"                   "=r")
...
(define_insn "msubr32"
  ...
  "TARGET_ZPN"
  "msubr32\t%0, %2, %3"
  [(set_attr "type"   "msubr32")
   (set_attr "mode"   "SI")])

;; MADDR32, MSUBR32 for standard usage
(define_insn "fmasi4"
  [(set (match_operand:SI 0 "register_operand"                   "=r")
...
(define_insn "vec_merge<mode>"
  ...
  {
    const char *pats[] = {
        TARGET_ZBPBO ? "pack\t%0, %1, %2" : "pkbb<bits>\t%0, %2, %1",
        "pktb<bits>\t%0, %2, %1",
        TARGET_ZBPBO ? "packu\t%0, %1, %2" : "pktt<bits>\t%0, %2, %1",
        "pkbt<bits>\t%0, %2, %1",
        TARGET_ZBPBO ? "pack\t%0, %2, %1" : "pkbb<bits>\t%0, %1, %2",
        "pkbt<bits>\t%0, %1, %2",
        TARGET_ZBPBO ? "packu\t%0, %2, %1" : "pktt<bits>\t%0, %1, %2",
        "pktb<bits>\t%0, %1, %2" };
    return pats[which_alternative];
  }
  [(set_attr "type" "dsp")
...
(define_insn "vec_set<mode>_internal"
  [(set (match_operand:VSHI 0 "register_operand"   "=  r,   r")
    (vec_merge:VSHI
      ...
      (match_operand:SI 3 "imm_1_2_operand"    " c01, c02")))]
  "TARGET_ZPN"
  "@
   pktb<bits>\t%0, %2, %1
   pkbb<bits>\t%0, %1, %2"
...
(define_expand "vec_unpacks_lo_rvpv4qi"
  [(match_operand:RVPV2HI 0 "register_operand" "=r")
   (match_operand:RVPV4QI 1 "register_operand" " r")]
  "TARGET_ZPN && !TARGET_64BIT"
{
...
;; ZUNPKD810 and SUNPKD810 in RV64P
...
;; fsr, fsri, fsrw
;; __rv_fsr(rs1, rs2, rs3) == fsr rd, rs1, rs3, rs2
(define_insn "fsrw"
  [(set (match_operand:SI 0 "register_operand"     "=r")
    (unspec: SI [(match_operand:SI 1 "register_operand" "r")
        (match_operand:SI 2 "register_operand" "r")
